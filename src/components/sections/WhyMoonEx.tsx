  ...
  return (
    <section id="products" className="max-container max-sm:mt-12 font-fira">
      <div className="flex flex-col justify-start gap-5">
        <h2 className="text-white text-4xl -palanquin font-bold">
        ...
        <Table>
          ...
          <TableBody className="text-white">
            {tableData.map((row, index) => (
              <TableRow key={index}>
                <TableCell className="text-center py-5 border-r border-slate-600">{row.column1}</TableCell>
                <TableCell className="border-r border-slate-600">
